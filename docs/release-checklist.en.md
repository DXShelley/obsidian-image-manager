...
- The Git tag must exactly match `manifest.json.version`, for example `4.0.2`, without a `v` prefix.
- GitHub Release assets must include `manifest.json`, `main.js`, `styles.css`, and `note-image-manager-<version>.zip`.
